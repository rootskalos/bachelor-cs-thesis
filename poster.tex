...
\newcommand{\badge}[1]{\tikz[baseline=-0.7ex]\node[circle, fill=white,
  text=uorange, font=\LARGE\bfseries\sffamily, inner sep=0pt,
  minimum size=13mm]{#1};}
...
\centering
{\titlefont\color{white}\veryHuge Mitigación de la resistencia evolutiva en glioblastoma\\[1mm]
 mediante aprendizaje por refuerzo multiagente adversarial}\\[8mm]
...
\vspace{2mm}
\pfig[0.78\linewidth]{images/dynamics_baseline.png}{Dinámica de referencia del simulador calibrado: poblaciones sensible y resistente bajo distintos regímenes de dosis.}
...
{\small\color{ink}
\textbf{\color{udark}Referencias clave:} Stupp (2005); Gatenby \& Gallaher (2017); Stankova (2019); Pinto et al.\ RARL (2017); Gallagher (2024); Yu et al.\ MAPPO (2022); de Witt et al.\ IPPO (2020); GDSC2; DepMap.\hfill
\textbf{\color{udark}GitHub:} GBMARL \quad \textbf{\color{udark}Correo:} klazo / gsegovia @utec.edu.pe}
\end{tcolorbox}
